...
# ╔═╡ dae3f41f-87a6-4f4b-90fe-e0379c623b51
using MinimallyDisruptiveCurves

# ╔═╡ ab1dcd16-9e4e-11ec-3d44-d71e0e4f4f39
md"""
...
# ╔═╡ 45b60fe5-d8b6-45b5-91de-3dce747423c9
θ₀ = [5.,6.,7.]

# ╔═╡ d5e5ba1b-6657-48b6-8167-95b6a3de5479
C(θ) = sum( @. (θ - θ₀)^2)

# ╔═╡ 7caa9840-2434-45f6-b3c8-bc4dee5b9c7e
function C(θ, g)
    g[:] = @. 2(θ-θ₀)
    return C(θ)
end

# ╔═╡ 64e63817-e342-4b6b-8ac4-e5b56c5658f3
g = deepcopy(θ₀)

# ╔═╡ d50dcff0-8b71-4a60-863f-520613a511f3
C(θ₀, g)

# ╔═╡ 152f8871-6aa0-4e31-8876-1f42db154d03
g

# ╔═╡ 5f320fc7-b73c-4179-8e45-89dbb7ba9fab
md"""
Next let's build a transformation structure:
"""

# ╔═╡ af46717e-b7a8-4aac-ac49-b3b43f9cb9e5
T(p) = @. p + 1

# ╔═╡ 31b5ec9a-7ac1-484b-b490-2f2175702957
Tinv(p) = @. p - 1

# ╔═╡ a920abd7-1e76-4176-9505-4c2ec7bb246d
Trf = TransformationStructure("simple_transform", T, Tinv)

# ╔═╡ f38cd26b-b3a0-480a-b2cb-6523b6096a82
md"""
and reparameterise the cost function with it...
"""

# ╔═╡ d72db3a6-46e4-4e14-93b5-5bbcb4005214
D, θnew = transform_cost(C, θ₀, Trf)

# ╔═╡ 57d8b290-29a3-458b-8086-30f953ed34cb
[θnew, D(θnew, g), g]

# ╔═╡ 352cd9e4-665c-46c6-b4b6-13ec700571ca
md"""
Done! Now we have made some preloaded `TransformationStructure`s to get you started:
"""

# ╔═╡ bb7b6b09-f404-4e25-ad64-7097652456d0
LA  = logabs_transform(θ₀);

# ╔═╡ 2ade0e82-80ab-46e7-b072-aa1a84c466c2
md"""
...
# ╔═╡ 2ebe244b-9366-408f-a383-2a39f97fcae2
idxs = [1,3]

# ╔═╡ d857639d-4c5f-49e1-b01f-f0fff647cc94
biases = [400.,1/400]

# ╔═╡ 0565c581-4fb5-44a0-817c-760baad4d6ab
BA = bias_transform(θnew, idxs, biases );

# ╔═╡ 216d0253-c8c6-4684-bef6-d6140a6e4295
md"""
...
git-tree-sha1 = "438af7e9a8d0713779b298ea6e4b92b84b0b4107"
